...

{
	LOCAL this IS LEXICON(
		...
		"vessel_to_body", vessel_to_body@,
		"body_to_vessel", body_to_vessel@,
		"body_to_body", body_to_body@,
		"fill_rsvp", fill_rsvp@
	).

	LOCAL FUNCTION Fill_RSVP {
		PARAMETER that IS LEXICON().
		that:ADD("vessel_to_vessel", vessel_to_vessel@).
		that:ADD("vessel_to_body", vessel_to_body@).
		that:ADD("body_to_vessel", body_to_vessel@).
		that:ADD("body_to_body", body_to_body@).
		SET rsvp TO that.
		RETURN that.
	}
