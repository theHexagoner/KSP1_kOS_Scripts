...

{
	...
	LOCAL this IS LEXICON(
		"create_maneuver", create_maneuver@,
		"create_raw_maneuver", create_raw_maneuver@,
		"fill_rsvp", fill_rsvp@
	).

	LOCAL FUNCTION Fill_RSVP {
		PARAMETER that IS LEXICON().
		that:ADD("create_maneuver", create_maneuver@).
		that:ADD("create_raw_maneuver", create_raw_maneuver@).
		SET rsvp TO that.
		RETURN that.
	}	
