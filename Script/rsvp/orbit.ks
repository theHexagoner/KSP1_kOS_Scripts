...

{
	...
	LOCAL this IS LEXICON(
		"transfer_deltav", transfer_deltav@,
		"orbital_state_vectors", orbital_state_vectors@,
		"equatorial_ejection_deltav", equatorial_ejection_deltav@,
		"vessel_ejection_deltav", vessel_ejection_deltav@,
		"vessel_ejection_deltav_from_body", vessel_ejection_deltav_from_body@,
		"circular_insertion_deltav", orbit_insertion_deltav@:bind(true),
		"elliptical_insertion_deltav", orbit_insertion_deltav@:bind(false),
		"vessel_insertion_deltav", vessel_insertion_deltav@,
		"none_insertion_deltav", none_insertion_deltav@,
		"minimum_escape_velocity", minimum_escape_velocity@,
		"ideal_hohmann_transfer_period", ideal_hohmann_transfer_period@,
		"synodic_period", synodic_period@,
		"max_period", max_period@,
		"min_period", min_period@,
		"time_at_periapsis", time_at_periapsis@,
		"time_at_soi_edge", time_at_soi_edge@,
		"duration_from_soi_edge", duration_from_soi_edge@,
		"offset_from_soi_edge", offset_from_soi_edge@,
		"fill_rsvp", fill_rsvp@
	).

	LOCAL FUNCTION Fill_RSVP {
		PARAMETER that IS LEXICON().
		that:ADD("transfer_deltav", transfer_deltav@).
		that:ADD("orbital_state_vectors", orbital_state_vectors@).
		that:ADD("equatorial_ejection_deltav", equatorial_ejection_deltav@).
		that:ADD("vessel_ejection_deltav", vessel_ejection_deltav@).
		that:ADD("vessel_ejection_deltav_from_body", vessel_ejection_deltav_from_body@).
		that:ADD("circular_insertion_deltav", orbit_insertion_deltav@:bind(true)).
		that:ADD("elliptical_insertion_deltav", orbit_insertion_deltav@:bind(false)).
		that:ADD("vessel_insertion_deltav", vessel_insertion_deltav@).
		that:ADD("none_insertion_deltav", none_insertion_deltav@).
		that:ADD("minimum_escape_velocity", minimum_escape_velocity@).
		that:ADD("ideal_hohmann_transfer_period", ideal_hohmann_transfer_period@).
		that:ADD("synodic_period", synodic_period@).
		that:ADD("max_period", max_period@).
		that:ADD("min_period", min_period@).
		that:ADD("time_at_periapsis", time_at_periapsis@).
		that:ADD("time_at_soi_edge", time_at_soi_edge@).
		that:ADD("duration_from_soi_edge", duration_from_soi_edge@).
		that:ADD("offset_from_soi_edge", offset_from_soi_edge@).
		SET rsvp TO that.
		RETURN that.
	}
