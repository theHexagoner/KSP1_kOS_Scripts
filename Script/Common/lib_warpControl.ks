...
// nuggreat the great wrote all this
// 

FUNCTION warp_control_init {
	//public 
	PARAMETER easeFactor TO 1.5,//the smaller this number the later the warp control will leave reducing the rate of time warp, too small and you will over shoot target
